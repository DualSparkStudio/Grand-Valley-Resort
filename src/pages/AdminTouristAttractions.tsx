...
const AdminTouristAttractions: React.FC = () => {
  ...
  const handleDelete = async (id: number) => {
    if (!confirm('Are you sure you want to delete this tourist attraction?')) return
    ...
    <>
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">Manage places to visit in Ratnagiri</p>
        </div>
        ...
        {attractions.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 mb-6">Get started by adding the first tourist attraction in Ratnagiri.</p>
            <button
              onClick={() => openModal('add')}
