              ...
              <div>
                ...
                <div className="flex space-x-3">
                  <a
                    ...
                    className="w-8 h-8 bg-white/20 hover:bg-pink-600 rounded-full flex items-center justify-center transition-colors duration-200"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-8 h-8 bg-white/20 hover:bg-green-600 rounded-full flex items-center justify-center transition-colors duration-200"
                  >
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
